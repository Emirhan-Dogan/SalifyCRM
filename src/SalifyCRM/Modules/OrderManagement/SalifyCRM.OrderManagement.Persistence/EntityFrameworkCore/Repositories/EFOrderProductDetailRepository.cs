...
{
    public class EFOrderProductDetailRepository : EFEntityBaseRepository<OrderProductDetail, SalifyDbContext>, IOrderProductDetailRepository
    {
        public EFOrderProductDetailRepository(SalifyDbContext context) : base(context)
        {
