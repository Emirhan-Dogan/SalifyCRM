...
{
    public class EFStoreRepository : EFEntityBaseRepository<Store, SalifyDbContext>, IStoreRepository
    {
        public EFStoreRepository(SalifyDbContext context) : base(context)
        {
