...
{
    public class EFSubscriptionRepository : EFEntityBaseRepository<Subscription, SalifyDbContext>, ISubscriptionRepository
    {
        public EFSubscriptionRepository(SalifyDbContext context) : base(context)
        {
