...
{
    public class EFProductCategoryMappingRepository : EFEntityBaseRepository<ProductCategoryMapping, SalifyDbContext>, IProductCategoryMappingRepository
    {
        public EFProductCategoryMappingRepository(SalifyDbContext context) : base(context)
        {
