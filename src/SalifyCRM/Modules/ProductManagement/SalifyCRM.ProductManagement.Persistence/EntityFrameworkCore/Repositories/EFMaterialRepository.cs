...
{
    public class EFMaterialRepository : EFEntityBaseRepository<Material, SalifyDbContext>, IMaterialRepository
    {
        public EFMaterialRepository(SalifyDbContext context) : base(context)
        {
