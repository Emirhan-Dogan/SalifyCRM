...
{
    public class EFProductNoteRepository : EFEntityBaseRepository<ProductNote, SalifyDbContext>, IProductNoteRepository
    {
        public EFProductNoteRepository(SalifyDbContext context) : base(context)
        {
