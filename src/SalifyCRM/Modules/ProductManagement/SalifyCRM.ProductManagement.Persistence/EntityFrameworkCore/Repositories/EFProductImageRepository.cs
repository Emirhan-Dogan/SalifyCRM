...
{
    public class EFProductImageRepository : EFEntityBaseRepository<ProductImage, SalifyDbContext>, IProductImageRepository
    {
        public EFProductImageRepository(SalifyDbContext context) : base(context)
        {
