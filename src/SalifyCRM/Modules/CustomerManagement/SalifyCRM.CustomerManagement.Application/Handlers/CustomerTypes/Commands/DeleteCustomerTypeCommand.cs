...
{
    public class DeleteCustomerTypeCommand : IRequest<IResult>
    {
        public int Id { get; set; }
        public int DeletedUserId { get; set; }

        public class DeleteCustomerTypeCommandHandler : IRequestHandler<DeleteCustomerTypeCommand, IResult>
        {
            ...
            public async Task<IResult> Handle(DeleteCustomerTypeCommand request, CancellationToken cancellationToken)
            {
                if (request.Id < 0)
                {
                ...
                _customerTypeRepository.Delete(customerType);
