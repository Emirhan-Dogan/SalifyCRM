...
{
    public class DeleteSocialMediaCommand : IRequest<IResult>
    {
        public int Id { get; set; }
        public int DeletedUserId { get; set; }

        public class DeleteSocialMediaCommandHandler : IRequestHandler<DeleteSocialMediaCommand, IResult>
        {
            ...
            public async Task<IResult> Handle(DeleteSocialMediaCommand request, CancellationToken cancellationToken)
            {
                if (request.Id < 0)
                {
