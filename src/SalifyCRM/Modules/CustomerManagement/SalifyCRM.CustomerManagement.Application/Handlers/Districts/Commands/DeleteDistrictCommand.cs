...
{
    public class DeleteDistrictCommand : IRequest<IResult>
    {
        public int Id { get; set; }
        public int DeletedUserId { get; set; }

        public class DeleteDistrictCommandHandler : IRequestHandler<DeleteDistrictCommand, IResult>
        {
            ...
            public async Task<IResult> Handle(DeleteDistrictCommand request, CancellationToken cancellationToken)
            {
                if (request.Id < 0)
                {
