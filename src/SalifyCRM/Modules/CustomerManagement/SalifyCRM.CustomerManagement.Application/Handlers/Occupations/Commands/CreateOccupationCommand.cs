...
{
    public class CreateOccupationCommand : IRequest<IResult>
    {
        ...
        public class CreateOccupationCommandHandler : IRequestHandler<CreateOccupationCommand, IResult>
        {
            private readonly IOccupationRepository _occupationRepository;
            private readonly IUserRepository _userRepository;
            private readonly IMediator _mediator;

            public CreateOccupationCommandHandler(
            ...
            public async Task<IResult> Handle(CreateOccupationCommand request, CancellationToken cancellationToken)
            {
                var validator = new CreateOccupationValidator();
