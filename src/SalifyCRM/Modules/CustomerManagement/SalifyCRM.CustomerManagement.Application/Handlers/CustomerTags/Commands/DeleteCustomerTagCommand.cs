...
{
    public class DeleteCustomerTagCommand : IRequest<IResult>
    {
        public int Id { get; set; }
        public int DeletedUserId { get; set; }

        public class DeleteCustomerTagCommandHandler : IRequestHandler<DeleteCustomerTagCommand, IResult>
        {
            private readonly ICustomerTagRepository _customerTagRepository;
            private readonly IUserRepository _userRepository;
            private readonly IMediator _mediator;

            public DeleteCustomerTagCommandHandler(
            ...
            public async Task<IResult> Handle(DeleteCustomerTagCommand request, CancellationToken cancellationToken)
            {
                if (request.Id < 0)
                {
