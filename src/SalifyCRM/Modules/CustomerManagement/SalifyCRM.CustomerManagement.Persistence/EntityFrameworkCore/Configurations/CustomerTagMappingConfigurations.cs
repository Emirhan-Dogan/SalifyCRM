...
{
    public class CustomerTagMappingConfigurations : IEntityTypeConfiguration<CustomerTagMapping>
    {
        public void Configure(EntityTypeBuilder<CustomerTagMapping> builder)
        {
            builder.ToTable("customer_tag_mappings");
