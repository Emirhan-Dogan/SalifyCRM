...
{
    public class EFDistrictRepository : EFEntityBaseRepository<District, SalifyDbContext>, IDistrictRepository
    {
        public EFDistrictRepository(SalifyDbContext salifyDbContext) : base(salifyDbContext)
        {
