...
{
    public class EFSocialMediaRepository : EFEntityBaseRepository<SocialMedia, SalifyDbContext>, ISocialMediaRepository
    {
        public EFSocialMediaRepository(SalifyDbContext salifyDbContext) : base(salifyDbContext)
        {
