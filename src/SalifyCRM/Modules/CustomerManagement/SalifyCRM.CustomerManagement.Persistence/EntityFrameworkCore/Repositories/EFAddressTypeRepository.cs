...
{
    public class EFAddressTypeRepository : EFEntityBaseRepository<AddressType, SalifyDbContext>, IAddressTypeRepository
    {
        public EFAddressTypeRepository(SalifyDbContext salifyDbContext) : base(salifyDbContext)
        {
