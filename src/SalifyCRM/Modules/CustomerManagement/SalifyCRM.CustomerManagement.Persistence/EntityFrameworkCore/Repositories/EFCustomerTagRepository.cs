...
{
    public class EFCustomerTagRepository : EFEntityBaseRepository<CustomerTag, SalifyDbContext>, ICustomerTagRepository
    {
        public EFCustomerTagRepository(SalifyDbContext salifyDbContext) : base(salifyDbContext)
        {
