...
{
    public class EFCountryRepository : EFEntityBaseRepository<Country, SalifyDbContext>, ICountryRepository
    {
        public EFCountryRepository(SalifyDbContext salifyDbContext) : base(salifyDbContext)
        {
