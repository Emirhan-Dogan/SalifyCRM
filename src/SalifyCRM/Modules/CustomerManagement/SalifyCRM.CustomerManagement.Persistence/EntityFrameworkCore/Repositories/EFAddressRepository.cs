...
{
    public class EFAddressRepository : EFEntityBaseRepository<Address, SalifyDbContext>, IAddressRepository
    {
        public EFAddressRepository(SalifyDbContext salifyDbContext) : base(salifyDbContext)
        {
