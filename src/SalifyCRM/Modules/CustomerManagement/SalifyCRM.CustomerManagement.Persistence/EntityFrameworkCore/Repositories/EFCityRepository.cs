...
{
    public class EFCityRepository : EFEntityBaseRepository<City, SalifyDbContext>, ICityRepository
    {
        public EFCityRepository(SalifyDbContext salifyDbContext) : base(salifyDbContext)
        {
