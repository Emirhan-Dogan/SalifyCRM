...
namespace SalifyCRM.CustomerManagement.Tests.Application.Handlers.CustomerPermissions.Commands
{
    ...
    public class AddPermissionToCustomerCommandHandlerTests
    {
        ...
        private AddPermissionToCustomerCommand.AddPermissionToCustomerCommandHandler _addPermissionToCustomerCommandHandler;
        ...
        public void SetUp()
        {
            ...
            _addPermissionToCustomerCommandHandler = new AddPermissionToCustomerCommand
                .AddPermissionToCustomerCommandHandler(
